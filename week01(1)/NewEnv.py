...
class NewEnv(gym.Env):
    ...
    def render(self, mode='human'):
        ...
        if self.viewer is None:
            ...
            #创建不可到点
            self.shizhu1 = rendering.make_circle(40)
            self.circletrans = rendering.Transform(translation=(150,450))
            self.shizhu1.add_attr(self.circletrans)
            self.shizhu1.set_color(0.8,0.6,0.4)

            #创建第二个不可到点
            self.shizhu2 = rendering.make_circle(40)
            self.circletrans = rendering.Transform(translation=(450, 150))
            self.shizhu2.add_attr(self.circletrans)
            self.shizhu2.set_color(0.8, 0.6, 0.4)
            ...
            self.viewer.add_geom(self.shizhu2)
